...
<!-- ##### Header Area Start ##### -->
    ...
    <!-- ##### Header Area End ##### -->
<fieldset>
<h1 class="h1">Q 3. 좋아하는 색깔은?</h1>
<form action ="ta4" method="post">
<section>
<input id='one' type="radio" name ="answer3" value="푸른" checked>
<label for='one'>
	<span></span>
	 Blue
 	<ins><i>Blue</i></ins>
</label>
<input id='two' type="radio" name ="answer3" value="초록">
<label for='two'>
	<span></span>
	Green
 	<ins><i>Green</i></ins>
</label>
<input id='three' type="radio" name ="answer3" value="빨간">
<label for='three'>
	<span></span>
	 Red
 	<ins><i>Red</i></ins>
</label>
<input id='four' type="radio" name ="answer3" value="하얀">
<label for='four'>
	<span></span>
	 White
 	<ins><i>White</i></ins>
