...
<!-- ##### Header Area Start ##### -->
    ...
    <!-- ##### Header Area End ##### -->
<fieldset>
<h1 class="h1">Q 4. 평소 즐겨 입는 옷은?</h1>
<form action ="ta5" method="post">
<section>
<input id='one' type="radio" name ="answer4" value="트레이닝" checked>
<label for='one'>
	<span></span>
	 트레이닝
 	<ins><i>트레이닝</i></ins>
</label>
<input id='two' type="radio" name ="answer4" value="캐쥬얼">
<label for='two'>
	<span></span>
	캐쥬얼
 	<ins><i>캐쥬얼</i></ins>
</label>
<input id='three' type="radio" name ="answer4" value="정장">
<label for='three'>
	<span></span>
	 정장
 	<ins><i>정장</i></ins>
</label>
<input id='four' type="radio" name ="answer4" value="화려한">
<label for='four'>
	<span></span>
	 화려한 옷
 	<ins><i>화려한 옷</i></ins>
