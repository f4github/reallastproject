...
<body>
    ...
    <section class="breadcumb-area bg-img d-flex align-items-center justify-content-center" style="background-image: url(resources/img/bg-img/bg-2.jpg);">
    ...
    <section class="our-milestones section-padding-100-0 bg-img bg-overlay bg-fixed" style="background-image: url(resources/img/bg-img/bg-4.jpg);">
        <div class="container">
            <div class="row justify-content-center">
    ...
    <section class="testimonial-area section-padding-100 bg-img" style="background-image: url(resources/img/core-img/pattern.png);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="testimonial-content">
                        ...
                        <div class="testimonial-slides owl-carousel">
                            ...
                            <div class="single-testimonial">
                                ...
                                <img src="resources/img/core-img/trip.png" alt="">
                            </div>
